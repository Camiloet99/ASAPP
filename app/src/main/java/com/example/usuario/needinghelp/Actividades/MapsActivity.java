...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void GenerarPunto(float la, float lo, String nom, String de){
        AlertDialog.Builder builder = new AlertDialog.Builder(MapsActivity.this);
        builder.setMessage("Se generó el punto");
        //    LatLng latLng = new LatLng(peticion.getLat(),peticion.getLon());
        //    mMap.addMarker(new MarkerOptions().position(latLng).title(peticion.getNombre()).snippet(peticion.getDescripcion()));
    }
}
